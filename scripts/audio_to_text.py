...
def main():
    ...
    if args.engine == 'faster-whisper':
        ...
        raw = mlx_whisper.transcribe(str(args.input), path_or_hf_repo=model_id,
    ...
    print(json.dumps({'status':'completed', 'engine':args.engine, 'segments':len(segments),
